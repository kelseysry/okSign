...
const MatchProfilePics = ({matchProfileObj}) => {
  ...
  let [number_likes, setNumLikes] = useState(matchProfileObj[0]?.number_likes)
  ...
  const handleIncreaseProfileLikes = async(e) => {
    ...
    console.log("matchProfileObj[0]", matchProfileObj[0])
    console.log("edit profile in likes", editProfile)
      ...
      <>
          <div className="oneMatchProfileContainerHeaderPage">
            ...
            <div className="matchButtonsContainer">
              ...
              >Like {matchProfileObj[0]?.number_likes} <i className="fas fa-heart"></i></button>
            </div>
