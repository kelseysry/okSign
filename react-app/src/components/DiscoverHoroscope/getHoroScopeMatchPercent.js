...
export {horoscopeContent}


export const getHoroscopeMatchPercent = (matchHoroscopeId, userHoroscopeId) => {
  ...
  if((+userHoroscopeId === 11 && +matchHoroscopeId === 4 )|| (+userHoroscopeId === 4 && +matchHoroscopeId === 11 )) {
    ...
    if((+userHoroscopeId === 2 && +matchHoroscopeId === 5 )|| (+userHoroscopeId === 5 && +matchHoroscopeId === 2 )) {
      horoscopeContent="The relationship of Taurus and Leo could be aggressively challenging if not for their warm natures ruled by Venus and the Sun. Although they are both signs of fixed quality with entirely different natures, if they gather enough patience before they enter their relationship, they have a chance to become your archetypal couple of a girl and a boy. When their masculine and feminine principles are in balance, they can use them to mend their romantic, intellectual and financial circumstances and really enjoy each other."
      return 29
    }

    // Taurus and virgo match
    if((+userHoroscopeId === 2 && +matchHoroscopeId === 6 )|| (+userHoroscopeId === 6 && +matchHoroscopeId === 2 )) {
      horoscopeContent="In general, Taurus is there to teach Virgo about love, and tenderness. Virgo needs to be flexible enough to value their Taurus and give them the intellectual view on things they might idealize. Their relationship could be a match made in heaven, only if they are not too scared of being hurt and too distrustful. If they do give in to each other and fall madly in love, they could be the combination of a clear heart, represented by Taurus, and a clear mind, represented by Virgo. What more would they need than each other?"
      return 73
    }
    ...
    if((+userHoroscopeId === 4 && +matchHoroscopeId === 8 )|| (+userHoroscopeId === 8 && +matchHoroscopeId === 4 )) {
      horoscopeContent="The sign of Scorpio is associated with death and all kinds of bad things, but all of their maliciousness comes from their emotional and romantic repression. Cancer can usually understand the need of their Scorpio partner to express their deepest, darkest emotions in their romantic life. If Cancer partner doesn’t get scared or too forced to do something they are not ready for, a romantic relationship between Cancer and Scorpio can be deeply satisfying for both partners.This is a relationship of two Water signs and because of this their romantic life needs to reflect all of their emotional connection or a lack of it if there is any. When they fall in love, they will both need to express their feelings and the intimacy they might share is incredible."
      return 90
    }
    ...
    if((+userHoroscopeId === 4 && +matchHoroscopeId === 12 )|| (+userHoroscopeId === 12 && +matchHoroscopeId === 4 )) {
      horoscopeContent="As two Water signs, Cancer and Pisces connect through emotions, usually as soon as they lay eyes on each other. This is one of the typical combinations of zodiac signs for love at first sight. Their main challenge is hidden in the changeable nature of the sign of Pisces, not because it is there, but because they might fear to show it. Their biggest problem lies in the fact that they give priority to different types of love in their life. If passion and sensual, romantic love isn’t there, Pisces will rarely be satisfied with the love they get from their family, and Cancer would find a life without a family nest very depressing. A fine balance needs to be made between excitement and stability, and they could be one of the most wonderful couples of the zodiac – Cancer inspired and Pisces with a feel of home."
      return 72
    }
    ...
    if((+userHoroscopeId === 6 && +matchHoroscopeId === 11 )|| (+userHoroscopeId === 11 && +matchHoroscopeId === 6 )) {
      horoscopeContent="Virgo can represent everything that Aquarius runs from – practical, worried about health and earthly things, down to Earth, cleaning obsessed maniac. Imagine how incredibly irresponsible, chaotic and unrealistic Aquarius looks to them. Their strongest meeting point is in their rationality and communication, and this can be used to overcome many problems that their differences result in. Unfortunately, in most cases they will not have enough chemistry to start a relationship, let alone stay in a romantic satisfying one for very long. If they take each other seriously, they might create incredible things together, as their great minds merge."
      return 30
    }
    ...
    if((+userHoroscopeId === 7 && +matchHoroscopeId === 8 )|| (+userHoroscopeId === 8 && +matchHoroscopeId === 7 )) {
      horoscopeContent="The relationship of Libra and Scorpio is in no way easy and light. Both of these partners will have to face their dark sides through this bond, and although this can lead to an incredible and intense romantic life, and emotions that no one else can understand, it might lead them both to a depressive hole they won’t easily get out of. The only way for this couple to last in a satisfying and gentle relationship, is for both partners to build a strong individual, independent life, or they will get sucked into the whirlpool of karmic emotions and obsessive, negative expectations."
      return 29
    }
